...
class CentroidalMpcRobotModelTest : public ::testing::Test {
 protected:
  void SetUp() override {
    pinocchioInterface = std::make_shared<PinocchioInterface>(
  ...
  void setupTestVectors() {
    ...
    testState =
        vector_t::Zero(testingModelInterface.getMpcRobotModel().getStateDim());
    ...
    testState.segment(12,
                      testingModelInterface.getMpcRobotModel().getJointDim()) =
        vector_t::Random(
            testingModelInterface.getMpcRobotModel().getJointDim());
    ...
    testInput =
        vector_t::Zero(testingModelInterface.getMpcRobotModel().getInputDim());
...
TEST_F(CentroidalMpcRobotModelTest, ConstructorAndDimensions) {
  EXPECT_EQ(testingModelInterface.getMpcRobotModel().getStateDim(),
            12 + testingModelInterface.getMpcRobotModel().getJointDim());
  EXPECT_EQ(testingModelInterface.getMpcRobotModel().getInputDim(),
            12 + testingModelInterface.getMpcRobotModel().getJointDim());
}

// Test clone functionality
TEST_F(CentroidalMpcRobotModelTest, CloneTest) {
  auto clonedModel = std::unique_ptr<CentroidalMpcRobotModel<scalar_t>>(
      testingModelInterface.getMpcRobotModel().clone());
  ASSERT_NE(clonedModel, nullptr);
  EXPECT_EQ(clonedModel->getStateDim(),
            testingModelInterface.getMpcRobotModel().getStateDim());
  EXPECT_EQ(clonedModel->getInputDim(),
...
TEST_F(CentroidalMpcRobotModelTest, StartIndices) {
  ...
  EXPECT_EQ(
      testingModelInterface.getMpcRobotModel().getJointVelocitiesStartindex(),
      12);  // 6 * N_CONTACTS

  // Contact indices
  EXPECT_EQ(
      testingModelInterface.getMpcRobotModel().getContactWrenchStartIndices(0),
      0);
  EXPECT_EQ(
      testingModelInterface.getMpcRobotModel().getContactWrenchStartIndices(1),
      6);
  EXPECT_EQ(
      testingModelInterface.getMpcRobotModel().getContactForceStartIndices(0),
      0);
  EXPECT_EQ(
      testingModelInterface.getMpcRobotModel().getContactMomentStartIndices(0),
      3);
}
...
TEST_F(CentroidalMpcRobotModelTest, GeneralizedCoordinates) {
  vector_t genCoords =
      testingModelInterface.getMpcRobotModel().getGeneralizedCoordinates(
          testState);
  EXPECT_EQ(genCoords.size(),
            6 + testingModelInterface.getMpcRobotModel()
                    .getJointDim());  // 6 (base) + 12 (joints)
...
TEST_F(CentroidalMpcRobotModelTest, BasePose) {
  vector6_t basePose =
      testingModelInterface.getMpcRobotModel().getBasePose(testState);
  ...
  testingModelInterface.getMpcRobotModel().setBasePose(modifiedState,
                                                       newBasePose);

  vector6_t retrievedPose =
      testingModelInterface.getMpcRobotModel().getBasePose(modifiedState);
...
TEST_F(CentroidalMpcRobotModelTest, BasePosition) {
  vector3_t basePos =
      testingModelInterface.getMpcRobotModel().getBasePosition(testState);
  ...
  testingModelInterface.getMpcRobotModel().setBasePosition(modifiedState,
                                                           newPos);

  vector3_t retrievedPos =
      testingModelInterface.getMpcRobotModel().getBasePosition(modifiedState);
...
TEST_F(CentroidalMpcRobotModelTest, BaseOrientation) {
  vector3_t baseOri =
      testingModelInterface.getMpcRobotModel().getBaseOrientationEulerZYX(
          testState);
  ...
  testingModelInterface.getMpcRobotModel().setBaseOrientationEulerZYX(
      modifiedState, newOri);

  vector3_t retrievedOri =
      testingModelInterface.getMpcRobotModel().getBaseOrientationEulerZYX(
          modifiedState);
...
TEST_F(CentroidalMpcRobotModelTest, BaseComVelocity) {
  vector3_t comLinVel =
      testingModelInterface.getMpcRobotModel().getBaseComLinearVelocity(
          testState);
  ...
  vector6_t comVel =
      testingModelInterface.getMpcRobotModel().getBaseComVelocity(testState);
...
TEST_F(CentroidalMpcRobotModelTest, JointAngles) {
  vector_t jointAngles =
      testingModelInterface.getMpcRobotModel().getJointAngles(testState);
  EXPECT_DOUBLE_EQ(jointAngles[0], 0.1);
  EXPECT_DOUBLE_EQ(jointAngles[1], -0.2);

  // Test setting joint angles
  vector_t modifiedState = testState;
  vector_t newJointAngles =
      vector_t::Random(testingModelInterface.getMpcRobotModel().getJointDim());
  testingModelInterface.getMpcRobotModel().setJointAngles(modifiedState,
                                                          newJointAngles);

  vector_t retrievedAngles =
      testingModelInterface.getMpcRobotModel().getJointAngles(modifiedState);
...
TEST_F(CentroidalMpcRobotModelTest, JointVelocities) {
  vector_t jointVels =
      testingModelInterface.getMpcRobotModel().getJointVelocities(testState,
                                                                  testInput);
  EXPECT_EQ(jointVels.size(),
            testingModelInterface.getMpcRobotModel().getJointDim());
  ...
  vector_t newJointVels =
      vector_t::Random(testingModelInterface.getMpcRobotModel().getJointDim());
  testingModelInterface.getMpcRobotModel().setJointVelocities(
      modifiedState, modifiedInput, newJointVels);

  vector_t retrievedVels =
      testingModelInterface.getMpcRobotModel().getJointVelocities(
          modifiedState, modifiedInput);
...
TEST_F(CentroidalMpcRobotModelTest, ContactWrench) {
  ...
  vector6_t leftWrench =
      testingModelInterface.getMpcRobotModel().getContactWrench(testInput, 0);
  ...
  vector6_t rightWrench =
      testingModelInterface.getMpcRobotModel().getContactWrench(testInput, 1);
  ...
  testingModelInterface.getMpcRobotModel().setContactWrench(modifiedInput,
                                                            newWrench, 0);

  vector6_t retrievedWrench =
      testingModelInterface.getMpcRobotModel().getContactWrench(modifiedInput,
                                                                0);
...
TEST_F(CentroidalMpcRobotModelTest, ContactForce) {
  vector3_t leftForce =
      testingModelInterface.getMpcRobotModel().getContactForce(testInput, 0);
  ...
  testingModelInterface.getMpcRobotModel().setContactForce(modifiedInput,
                                                           newForce, 1);

  vector3_t retrievedForce =
      testingModelInterface.getMpcRobotModel().getContactForce(modifiedInput,
                                                               1);
...
TEST_F(CentroidalMpcRobotModelTest, ContactMoment) {
  vector3_t leftMoment =
      testingModelInterface.getMpcRobotModel().getContactMoment(testInput, 0);
  ...
  testingModelInterface.getMpcRobotModel().setContactMoment(modifiedInput,
                                                            newMoment, 1);

  vector3_t retrievedMoment =
      testingModelInterface.getMpcRobotModel().getContactMoment(modifiedInput,
                                                                1);
...
TEST_F(CentroidalMpcRobotModelTest, CentroidalMomentum) {
  vector_t centroidalMomentum =
      testingModelInterface.getMpcRobotModel().getCentroidalMomentum(testState);
...
TEST_F(CentroidalMpcRobotModelTest, AdaptBasePoseHeight) {
  ...
  testingModelInterface.getMpcRobotModel().adaptBasePoseHeight(modifiedState,
                                                               heightChange);
...
TEST_F(CentroidalMpcRobotModelTest, SetGeneralizedCoordinates) {
  vector_t modifiedState = testState;
  vector_t newGenCoords =
      vector_t::Random(testingModelInterface.getMpcRobotModel()
                           .getGenCoordinatesDim());  // 6 base + 12 joints

  testingModelInterface.getMpcRobotModel().setGeneralizedCoordinates(
      modifiedState, newGenCoords);
  vector_t retrievedGenCoords =
      testingModelInterface.getMpcRobotModel().getGeneralizedCoordinates(
          modifiedState);
...
TEST_F(CentroidalMpcRobotModelTest, testGeneralizedVelocities) {
  vector_t qd =
      testingModelInterface.getMpcRobotModel().getGeneralizedVelocities(
          testState, testInput);
  vector_t qd_j =
      qd.tail(testingModelInterface.getMpcRobotModel().getJointDim());
...
TEST_F(CentroidalMpcRobotModelTest, BoundaryConditions) {
  ...
  EXPECT_NO_THROW(
      testingModelInterface.getMpcRobotModel().getBasePose(zeroState));
  EXPECT_NO_THROW(
      testingModelInterface.getMpcRobotModel().getJointAngles(zeroState));
  EXPECT_NO_THROW(
      testingModelInterface.getMpcRobotModel().getContactWrench(zeroInput, 0));
  EXPECT_NO_THROW(
      testingModelInterface.getMpcRobotModel().getContactWrench(zeroInput, 1));

  // Test contact indices
  for (size_t i = 0; i < 2; ++i) {
    EXPECT_NO_THROW(testingModelInterface.getMpcRobotModel().getContactWrench(
        testInput, i));
    EXPECT_NO_THROW(
        testingModelInterface.getMpcRobotModel().getContactForce(testInput, i));
    EXPECT_NO_THROW(testingModelInterface.getMpcRobotModel().getContactMoment(
        testInput, i));
  }
}
