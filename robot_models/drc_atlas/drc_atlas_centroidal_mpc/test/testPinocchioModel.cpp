...
void printFrameRotation(PinocchioInterface pin_interface, Eigen::VectorXd q,
...
void computeInverseDyanmics(PinocchioInterface pin_interface, Eigen::VectorXd q,
