...
def generate_launch_description():
    ...
    cfg = MPCLaunchConfig(
        ...
        mpc_config_pkg="engineai_sa01_centroidal_mpc",
        mpc_model_pkg="engineai_sa01_description",
        urdf_rel_path="/urdf/zq_sa01.urdf",
        xml_rel_path="/urdf/zq_sa01.xml",
        robot_name="engineai_sa01",
        solver="sqp",
        enable_debug=False,
    )
    ...
    cfg.ld.add_action(cfg.declare_plotjuggler_layout_path)
    ...
    cfg.ld.add_action(cfg.plotjuggler_node)
